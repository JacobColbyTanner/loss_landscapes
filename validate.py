...
np.save("/N/project/networkRNNs/loss_lndscape_data/Four_tasks_no_modules_all_corr.npy", all_corr)
...
plt.savefig("/N/project/networkRNNs/loss_lndscape_data/Four_tasks_no_modules.png", dpi=300, format='png', bbox_inches='tight')
plt.show()
